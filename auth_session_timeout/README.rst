...
.. |icon| image:: https://raw.githubusercontent.com/zeroincombenze/server-tools/10.0/auth_session_timeout/static/description/icon.png
...
* |menu| Setting > Apps |right_do| Select **auth_session_timeout** > Install
...
* |menu| Setting > Activate Developer mode
* |menu| Apps > Update Apps List
* |menu| Setting > Apps |right_do| Select **auth_session_timeout** > Update
