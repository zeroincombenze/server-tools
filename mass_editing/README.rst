...
* |menu| Setting > Apps |right_do| Select **mass_editing** > Install
...
* |menu| Setting > Activate Developer mode
* |menu| Apps > Update Apps List
* |menu| Setting > Apps |right_do| Select **mass_editing** > Update
...
* Serpent Consulting Services<support@serpentcs.com>
