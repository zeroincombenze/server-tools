...
.. |icon| image:: https://raw.githubusercontent.com/zeroincombenze/server-tools/10.0/sequence_date_range/static/description/icon.png
...
|en| Currently, the range_year is the date filled into the date_from.
...
* |menu| Setting > Apps |right_do| Select **sequence_date_range** > Install
...
* |menu| Setting > Activate Developer mode
* |menu| Apps > Update Apps List
* |menu| Setting > Apps |right_do| Select **sequence_date_range** > Update
