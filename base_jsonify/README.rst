===========================================
|icon| Base Jsonify/base_jsonify 10.0.1.1.0
===========================================
...
.. |thumbnail| image:: https://raw.githubusercontent.com/zeroincombenze/server-tools/10.0/base_jsonify/static/description/description.png
...
* `BEAU Sébastien <sebastien.beau@akretion.com>`__
* `Raphaël Reverdy <raphael.reverdy@akretion.com>`__
...
* `This module is part of the OCA/server-tools <https://github.com/OCA/server-tools/tree/10.0/base_jsonify>`__
