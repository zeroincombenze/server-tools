...
.. |icon| image:: https://raw.githubusercontent.com/zeroincombenze/server-tools/10.0/module_auto_update/static/description/icon.png
...
|en| This addon provides mechanisms to compute sha1 hashes of installed addons,
...
* |menu| Setting > Apps |right_do| Select **module_auto_update** > Install
...
* |menu| Setting > Activate Developer mode
* |menu| Apps > Update Apps List
* |menu| Setting > Apps |right_do| Select **module_auto_update** > Update
